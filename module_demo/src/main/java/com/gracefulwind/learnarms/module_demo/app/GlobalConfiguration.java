package com.gracefulwind.learnarms.module_demo.app;
...
import com.gracefulwind.learnarms.module_demo.BuildConfig;
...
public final class GlobalConfiguration implements ConfigModule {
    ...
    public void applyOptions(Context context, GlobalConfigModule.Builder builder) {
        LogUtil.e(TAG,"demo applyOptions");
    }
    ...
    public void injectAppLifecycle(Context context, List<AppLifecycles> lifecycles) {
        ...
        LogUtil.e(TAG,"demo injectAppLifecycle");
    }

    @Override
    public void injectActivityLifecycle(Context context, List<Application.ActivityLifecycleCallbacks> lifecycles) {
        LogUtil.e(TAG,"demo injectActivityLifecycle");
    }

    @Override
    public void injectFragmentLifecycle(Context context, List<FragmentManager.FragmentLifecycleCallbacks> lifecycles) {
        LogUtil.e(TAG,"demo injectFragmentLifecycle");
