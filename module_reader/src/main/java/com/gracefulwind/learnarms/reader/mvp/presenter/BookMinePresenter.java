 ...
 */
@ActivityScope
public class BookMinePresenter extends BasePresenter<BookMineContract.Model, BookMineContract.View> {
    @Inject
    ...
    @Inject
    public BookMinePresenter(BookMineContract.Model model, BookMineContract.View rootView) {
