...
import com.gracefulwind.learnarms.reader.mvp.model.BookReadModel;
...
public abstract class BookReadModule {

    @Binds
    abstract BookReadContract.Model bindMainModel(BookReadModel model);
}