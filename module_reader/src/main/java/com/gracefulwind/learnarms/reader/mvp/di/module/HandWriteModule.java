...
import com.gracefulwind.learnarms.reader.mvp.model.HandWriteModel;
...
public abstract class HandWriteModule {

    @Binds
    abstract HandWriteContract.Model bindHandWriteModel(HandWriteModel model);
}