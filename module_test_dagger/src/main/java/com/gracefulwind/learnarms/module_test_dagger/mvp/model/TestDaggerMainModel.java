 ...
 */
@ActivityScope
public class TestDaggerMainModel extends BaseModel implements TestDaggerMainContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public TestDaggerMainModel(IRepositoryManager repositoryManager) {
