 ...
 */
@ActivityScope
public class HandWritePresenter extends BasePresenter<HandWriteContract.Model, HandWriteContract.View> {
    @Inject
    ...
    @Inject
    public HandWritePresenter(HandWriteContract.Model model, HandWriteContract.View rootView) {
