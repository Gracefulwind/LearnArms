 ...
 */
@ActivityScope
public class BookActivityPresenter extends BasePresenter<BookActivityContract.Model, BookActivityContract.View> {
    @Inject
    ...
    @Inject
    public BookActivityPresenter(BookActivityContract.Model model, BookActivityContract.View rootView) {
