...
import com.gracefulwind.learnarms.reader.mvp.model.BookSearchModel;
...
public abstract class BookSearchModule {

    @Binds
    abstract BookSearchContract.Model bindMainModel(BookSearchModel model);
}