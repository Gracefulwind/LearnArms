 ...
 */
@ActivityScope
public class DaggerPage2Presenter extends BasePresenter<DaggerPage2Contract.Model, DaggerPage2Contract.View> {
    @Inject
    ...
    @Inject
    public DaggerPage2Presenter(DaggerPage2Contract.Model model, DaggerPage2Contract.View rootView) {
    ...
    public void requestData(){
        String page2Data = mModel.getPage2Data();
        mRootView.showPage2View(page2Data);
    }
}
