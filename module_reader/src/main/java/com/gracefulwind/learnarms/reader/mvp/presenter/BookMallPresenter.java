 ...
 */
@ActivityScope
public class BookMallPresenter extends BasePresenter<BookMallContract.Model, BookMallContract.View> {
    @Inject
    ...
    @Inject
    public BookMallPresenter(BookMallContract.Model model, BookMallContract.View rootView) {
