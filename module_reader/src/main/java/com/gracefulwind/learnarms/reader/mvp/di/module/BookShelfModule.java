...
import com.gracefulwind.learnarms.reader.mvp.model.BookShelfModel;
import com.gracefulwind.learnarms.reader.mvp.model.ReaderMainModel;
...
public abstract class BookShelfModule {
    ...
    @Binds
    abstract BookShelfContract.Model bindMainModel(BookShelfModel model);
}