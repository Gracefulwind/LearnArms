...
import com.gracefulwind.learnarms.reader.mvp.model.BookMineModel;
...
public abstract class BookMineModule {

    @Binds
    abstract BookMineContract.Model bindMainModel(BookMineModel model);
}