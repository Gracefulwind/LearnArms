 ...
 */
public abstract class LeftHorizonPageAnim extends PageAnimation {
    ...
    public LeftHorizonPageAnim(int w, int h, View view, OnPageChangeListener listener) {
        this(w, h, 0, 0, view, listener);
    }

    public LeftHorizonPageAnim(int w, int h, int marginWidth, int marginHeight,
