package com.gracefulwind.learnarms.ocr.mvp.ui.activity;
...
import com.gracefulwind.learnarms.ocr.R;
import com.gracefulwind.learnarms.ocr.R2;
import com.gracefulwind.learnarms.ocr.mvp.contract.MainContract;
import com.gracefulwind.learnarms.ocr.mvp.di.component.DaggerMainComponent;
import com.gracefulwind.learnarms.ocr.mvp.presenter.MainPresenter;
...
public class MainActivity extends MyBaseActivity<MainPresenter> implements MainContract.View {
    ...
    public int initView(@Nullable Bundle savedInstanceState) {
        return R.layout.ocr_activity_main; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
//        return 0;
    }
